<h2><a href="https://www.geeksforgeeks.org/problems/merge-two-strings2736/1?page=2&category=Strings&difficulty=Basic&sortBy=submissions">Merge two strings</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two&nbsp;strings <strong>S1</strong> and <strong>S2</strong> as input, the task is to merge them alternatively i.e. the first character of S1&nbsp;then the first character of S2 and so on till the strings end.</span><br>
